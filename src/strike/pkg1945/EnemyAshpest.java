...
public class EnemyAshpest extends Enemy{
    ...
    public EnemyAshpest(int x, int y, int width, int height, int speed) {
        ...
        try{
            ...
            this.gambarKnalpot[1]=ImageIO.read(new File("./Enemy/Enemy4/Exhaust1/exhaust2.png"));
            this.gambarKnalpot[2]=ImageIO.read(new File("./Enemy/Enemy4/Exhaust1/exhaust3.png"));
            this.gambarKnalpot[3]=ImageIO.read(new File("./Enemy/Enemy4/Exhaust1/exhaust4.png")); 
